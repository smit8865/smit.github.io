...
<!-- Mirrored from rainbowit.net/html/inbio/home-consulting.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Jul 2022 10:49:28 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="footer">
                <div class="social-share-style-1 mt--40">
                    ...
                    <ul class="social-share d-flex liststyle">
                        ...
                        <li class="github"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-linkedin">
                                    <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
                                    <rect x="2" y="9" width="4" height="12"></rect>
                                    <circle cx="4" cy="4" r="2"></circle>
                                </svg></a>
                    ...
                    <div class="col-lg-12">
                        <div class="banner-inner">
                            ...
                            <span class="cd-words-wrapper">
                                    ...
                                    <b class="is-hidden">TIME MANAGEMENT</b>
                                    <b class="is-hidden">BUSINESS STRATAGY</b>
                                </span>
                            </span>
                            <!-- type headline end -->
                        ...
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    ...
                                    <p class="description">Provide the Problem and Solution.
                                        <br>
                                        Identify the Target Market.</p>
                        ...
                        <div class="rn-service">
                            <div class="inner">
                                ...
                                <div class="content">
                                    ...
                                    <p class="description">Be intentional:
                                        <br>
                                        Be prioritized
                                        <br>
                                        Be focused
        ...
        <div class="rn-resume-area rn-section-gap section-separator" id="resume">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            <span class="subtitle">MY RESUME</span>
                ...
                <div class="row mt--45">
                    <div class="col-lg-12">
                        <ul class="rn-nav-list nav nav-tabs" id="myTabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="experience-tab" data-bs-toggle="tab" href="#experience" role="tab" aria-controls="experience" aria-selected="false">Certificate</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="interview-tab" data-bs-toggle="tab" href="#interview" role="tab" aria-controls="interview" aria-selected="false">Future Achievements</a>
                            </li>
                        </ul>
                                ...
                                <div class="personal-experience-inner mt--40">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-12">
                                            <div class="content">
                                                <span class="subtitle">2015 - 2018</span>
                                                <h4 class="maintitle">My Education </h4>
                                                <div class="experience-list">
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4>The K.P.E.S English School</h4>
                                                                    <span>Year (2015 - 2016)</span>
                                                                </div>
                                                                <div class="date-of-time">
                                                                    <span>10</span><span>BOARD</span>
                                                                </div>
                                                            </div>
                                                            <p class="description">SECONDARY Education (10 BOARD)</p>
                                                        </div>
                                                    </div>
                                                    <!-- End Single List  -->
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4> The K.P.E.S Education School</h4>
                                                                    <span>Year (2017 - 2018)</span>
                                                                </div>
                                                                <div class="date-of-time">
                                                                    <span>12</span><span>BOARD</span>
                                                                </div>
                                                            </div>
                                                            <p class="description">HIGHER SECONDARY (12 BOARD)</p>
                                                        </div>
                                                    </div>
                                                    <!-- End Single List  -->
                                        ...
                                        <div class="col-lg-6 col-md-12 col-12 mt_md--60 mt_sm--60">
                                            <div class="content">
                                                ...
                                                <h4 class="maintitle">My Bachelor</h4>
                                                <div class="experience-list">
                                                    ...
                                                    <div class="resume-single-list">
                                                        <div class="inner">
                                                            <div class="heading">
                                                                <div class="title">
                                                                    <h4>Swami Sahajanand College Of Commerce and Management( SSCCM )</h4>
                                                            ...
                                                            <p class="description">BACHELOR OF BUSINESS ADMINISTRATION IN HUMAN RESOURCE (HR).</p>
                                                        </div>
                                                    </div>
                                                    <!-- End Single List  -->
                                    ...
                                    <div class="row row--40">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="progress-wrapper">
                                                <div class="content">
                                                    <span class="subtitle">Features</span>
                                                    <h4 class="maintitle">Business Skill</h4>
                                                    ...
                                                    <div class="progress-charts">
                                                        ...
                                                        <div class="progress">
                                                            <div class="progress-bar wow fadeInLeft" data-wow-duration="0.6s" data-wow-delay=".4s" role="progressbar" style="width: 75%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"><span
                                                    ...
                                                    <!-- Start Single Progress Charts -->
                                                    <div class="progress-charts">
                                                        <h6 class="heading heading-h6">Goal Oriented</h6>
                                                        <div class="progress">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12 mt_sm--60">
                                            <div class="progress-wrapper">
                                                <div class="content">
                                                    ...
                                                    <!-- Start Single Progress Charts -->
                                                    <div class="progress-charts">
                                                        <h6 class="heading heading-h6">Team Building</h6>
                                                        <div class="progress">
                                                    ...
                                                    <!-- Start Single Progress Charts -->
                                                    <div class="progress-charts">
                                                        <h6 class="heading heading-h6">Decision Making</h6>
                                                        <div class="progress">
                                                            <div class="progress-bar wow fadeInLeft" data-wow-duration="0.7s" data-wow-delay=".5s" role="progressbar" style="width: 90%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"><span
                                                            class="percent-label">90%</span></div>
                                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12 col-12">
                                            <div class="content">
                                                ...
                                                <h4 class="maintitle">Certificate</h4>
                                                <div class="experience-list">
